...
export default function Header() {
  return (
    <>
      <Navbar className="navbar navbar-expand-lg navbar-light bg-light px-0 " expand="lg" style={{maxWidth:"100%",height:"auto"}}>
        <div className="container-fluid px-0" style={{maxWidth:"100%",height:"auto"}} >
          ...
          <div className="d-flex align-items-center">
            ...
            <button className="btn btn-success ms-4">Get A Quote</button>
          </div>
        </div>
      </Navbar>
    </>
